...
int i, j;
  ...
  double b[6] = {0};
  b[2] = mass*g;
  // b[3] = -1000*0*eulerX - 1000*omega[0];
  // b[4] = -1000*0*eulerY - 100*omega[1];
  //printf("%f %f %f %f \n",eulerX,eulerY,omega[0],omega[1]);
  // ram_display(&b[0],6,1,"b");
  ...
  //ram_display(&A12[0][0],6,6,"A12inv");
  ...
  //ram_multVec2SkewMat(double *ptr_b, int row, double *ptr_A)
  //ram_display(&pos_FR_com2foot[0],3,1,"pos");
  //double A[3][3];
  //ram_multVec2SkewMat(&pos_FR_com2foot[0],3, &A[0][0]);
  //ram_display(&A[0][0],3,3,"mat");
